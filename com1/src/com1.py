...
#
# Just: "${PATH_TO_BINARY}/com1 --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	if status == 0:
		...
		adapter = ic.createObjectAdapterWithEndpoints("CommonBehavior", "default -p 10000")
		adapter.activate()
		app.exec_()
